...
(defun exec-cmp (vm firstarg secondarg)
  ...
  (let ((arg1 (if (symbolp firstarg) (get vm firstarg) (cadr firstarg)))
    ...
    (if (null arg1) (setq arg1 0))
    (if (eql arg1 T) (setq arg1 1))
    (cond ((and (not(numberp arg1)) (eql arg1 arg2)) (progn (setf(get vm :EQ) 1) (setf(get vm :LT) 0) (setf(get vm :GT) 0)))
      ((and (not(numberp arg1)) (not (eql arg1 arg2))) (progn (setf(get vm :EQ) 0) (setf(get vm :LT) 0) (setf(get vm :GT) 0)))
      ((and(numberp arg1) (= arg1 arg2)) (progn (setf(get vm :EQ) 1) (setf(get vm :LT) 0) (setf(get vm :GT) 0)))
      ((and(numberp arg1) (< arg1 arg2)) (progn (setf(get vm :EQ) 0) (setf(get vm :LT) 1) (setf(get vm :GT) 0)))
      (t (progn (setf(get vm :EQ) 0) (setf(get vm :LT) 0) (setf(get vm :GT) 1)))
    )
  ) 
)
