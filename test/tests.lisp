...
(defun run-all-tests ()
  (setq test-count 0)
  (run-vm-tests);54 Tests
  (run-comp-tests);47 Tests
  (format t "~%Nombre total de tests réussis : ~D/101~%" test-count)
)

(defun run-comp-tests ()
  ;47 Tests
  ...
  (format t "~%Nombre total de tests réussis pour la compilation: ~D/47~%" test-comp-count)
)
...
(defun test-exec-store ()
  (vm-test '((STORE :R1 1)) 2 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm 1)))
  (vm-test '((STORE 2 1)) 2 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm 1)))
  (vm-test '((STORE 2 :R0)) 2 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm 1)))
  (vm-test '((STORE :R1 :R0)) 2 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm 1)))
)
(defun test-exec-load ()
  (vm-test '((LOAD 1 :R0)) 2 #'= (lambda () (set-to-vm-mem 'vm 1 2)))
...
(defun test-exec-div ()
  (vm-test '((DIV 5 :R0)) 1/5 #'=)
  (vm-test '((DIV :R1 :R0)) 1/2 #'=)
)
(defun test-exec-jmp ()
  (vm-test '((JMP label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
)

(defun test-exec-jgt ()
  (vm-test '((CMP 2 1)(JGT label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 1 2)(JGT label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
)
(defun test-exec-jge ()
  (vm-test '((CMP 2 1)(JGE label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 1 1)(JGE label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 1 2)(JGE label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
)
(defun test-exec-jlt ()
  (vm-test '((CMP 1 2)(JLT label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 2 1)(JLT label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
)
(defun test-exec-jle ()
  (vm-test '((CMP 1 2)(JLE label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 1 1)(JLE label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 2 1)(JLE label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
)
(defun test-exec-jeq ()
  (vm-test '((CMP 1 1)(JEQ label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
  (vm-test '((CMP 2 1)(JEQ label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
)
(defun test-exec-jne ()
  (vm-test '((CMP 1 1)(JNE label1)(MOVE 2 :R0)(LABEL label1)) 2 #'=)
  (vm-test '((CMP 2 1)(JNE label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)
)
(defun test-exec-jsr ()
  ;Test que la valeur de retour est bien mise sur la pile
  (vm-test '((JSR label1)(MOVE 2 :R0)(LABEL label1)) 501 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm (- (get 'vm :SP) 1))))
  ;Test que le saut s'effectue bien
  (vm-test '((JSR label1)(MOVE 2 :R0)(LABEL label1)) 1 #'=)

)
(defun test-exec-rtn ()
    ;;Test que rtn retourne au bon endroit
    (vm-test '((JMP finfonction1)(LABEL fonction1)(MOVE 2 :R0)(RTN)(LABEL inateignable)(MOVE 3 :R0)(LABEL finfonction1)(JSR fonction1)(MOVE 3 :R0)) 3 #'=)
    ;Test que la fonction appellée avec JSR s'execute bien et que le rtn saute par dessus le label inateignable
    (vm-test '((JMP finfonction1)(LABEL fonction1)(MOVE 2 :R0)(RTN)(LABEL inateignable)(MOVE 3 :R0)(LABEL finfonction1)(JSR fonction1)) 2 #'=)
)
(defun test-exec-push ()
  (vm-test '((PUSH 3)) 3 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm (- (get 'vm :SP) 1))))
  (vm-test '((PUSH :R1)) 2 #'= (lambda () ()) (lambda () (get-from-vm-mem 'vm (- (get 'vm :SP) 1))))
)
(defun test-exec-pop ()
  (vm-test '((PUSH 3)(POP :R0)) 3 #'=)
)
(defun test-exec-cmp ()
  ;Cas inférieurs
  (vm-test '((CMP 3 5)) '(0 1 0) #'=)
  (vm-test '((CMP :R0 :R1)) '(0 1 0) #'=)
  (vm-test '((CMP 1 :R1)) '(0 1 0) #'=)
  (vm-test '((CMP :R0 2)) '(0 1 0) #'=)
  ;Cas supérieurs
  (vm-test '((CMP 5 3)) '(0 0 1) #'=)
  (vm-test '((CMP :R1 :R0)) '(0 0 1) #'=)
  (vm-test '((CMP :R1 1)) '(0 0 1) #'=)
  (vm-test '((CMP 2 :R0)) '(0 0 1) #'=)
  ;Cas égalités
  (vm-test '((CMP 1 1)) '(1 0 0) #'=)
  (vm-test '((CMP :R3 :R0)) '(1 0 0) #'= (lambda () (setf (get 'vm :R3) 1)));;On set exceptionnellement R3 avant l'exécution
  (vm-test '((CMP :R0 1)) '(1 0 0) #'=)
  (vm-test '((CMP 1 :R0)) '(1 0 0) #'=)
)
(defun test-exec-funcall ()
  (vm-test '((PUSH 3) (PUSH (1 2 3 4 5 6)) (MOVE :SP :FP) (PUSH 2)  (FUNCALL member)) '(3 4 5 6) #'equal)
  (vm-test '((PUSH (6 2 3 4 5)) (MOVE :SP :FP) (PUSH 1)  (FUNCALL car)) 6 #'=)
)